...
class MySQL(object):
    ...
    def init_app(self, app):
        """Initialize the `app` for use with this :class:`~flask_mysqldb.MySQL`
        class. This is called automatically if `app` is passed to
        :meth:`~MySQL.__init__`.

        Args:
            app (flask.Flask): the application to configure for use with this
    ...
    def connection(self):
        ...
        Returns:
            Bound MySQL connection object if successful or ``None`` if
            unsuccessful.
        """
