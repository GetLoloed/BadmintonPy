...
class Pep517HookCaller(object):
    ...
    - cmd: a list of strings representing the command and arguments to execute,
      as would be passed to e.g. 'subprocess.check_call'.
    ...
    - extra_environ: a dict mapping environment variable names to values which
    ...
    def prepare_metadata_for_build_wheel(
        ...
        the dist-info extracted from that (unless _allow_fallback is False).
...
class LoggerWrapper(threading.Thread):
    """Read messages from a pipe and redirect them to a logger (see python's
    logging module).
    """
