...
def warn_if_run_as_root():
    ...
    In a virtual environment, sudo pip still writes to virtualenv. On
    Windows, users may run pip as Administrator without issues. This warning
    only applies to Unix root users outside of virtualenv.
    """
...
class RequirementCommand(IndexGroupCommand):
    ...
    def _build_package_finder(
        ...
        Args:
            ...
            session:
            target_python:
            ignore_requires_python: Whether to ignore incompatible
