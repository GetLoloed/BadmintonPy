...
def make_setuptools_shim_args(
    ...
    Args:
        setup_py_path: The path to setup.py to be wrapped.
        global_options: Additional global options.
        no_user_config: If True, disables personal user configuration.
        unbuffered_output: If True, adds the unbuffered switch to the argument
            list.
    """
    args = [sys.executable]
